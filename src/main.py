...
read_plot(filenames, "plots/n_ro_SR.pdf", labels, title, "Dimension", "Jacobi Rotations","2x_squared")
#"""
...
read_plot(filenames,"plots/comp_dense.pdf", labels, title, "Dimension", "Jacobi Rotations")
#"""
...
plot_eigvecs("vecs10.txt","plots/vecs10.pdf")
plot_eigvecs("vecs100.txt","plots/vecs100.pdf")
#"""
